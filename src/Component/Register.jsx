...
const Register = ({ setLoginUser }) => {
  ...
  const Signup = () => {
    ...
    if (!user.email == "" && !user.password == "") {
      setLoading(true);
      fetch(
        `${apiUrl}sign-up?referral=${referral}&email=${user.email}&password=${user.password}`,
          ...
          <div className="container">
            <div className="row pt-5">
              <div className="col-xl-6 col-md-6 mx-auto">
                <img className="w-100" src="images/register.png"></img>
              </div>
              <div className="col-xl-6 col-md-6 p-5 loginandregister">
                ...
                >
                  <div class="accordion-item password">
                    <label
                      class="collapsed Optional p-1 ml-0"
